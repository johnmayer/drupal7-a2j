 ...
 */
function a2j_author_theme($existing, $type, $theme, $path) {
  return array(
    // Register the newly added theme_form_content() hook so we can utilize
    // theme hook suggestions.
    // @see a2j_author_form_alter().
    'form_content' => array(
      'render element' => 'form',
      'path' => drupal_get_path('theme', 'a2j_author') . '/templates/form',
 ...
 */
function a2j_author_preprocess_search_results(&$variables, $hook) {
 ...
 */
function a2j_author_process_search_results(&$variables, $hook) {
 ...
 */
function a2j_author_preprocess_html(&$variables, $hook) {
  global $theme_key;
  ...
  $palette = variable_get('a2j_author_palette', 'default');
  if ($palette != 'default') {
 ...
 */
function a2j_author_menu_link($variables) {
  $output = '';
  ...
  a2j_author_menu_link_class($element);
  $sub_menu = '';
 ...
 */
function a2j_author_menu_link_class(&$element)  {
 ...
 */
function a2j_author_preprocess_page(&$variables, $hook) {
 ...
 */
function a2j_author_preprocess_node(&$variables, $hook) {
 ...
 */
function a2j_author_preprocess_two_33_66(&$variables, $hook) {
  $menu = menu_get_item();
...
function a2j_author_preprocess_three_25_50_25(&$variables, $hook) {
  $menu = menu_get_item();
 ...
 */
function a2j_author_preprocess_panels_pane(&$variables, $hook) {
  $pane = $variables['pane'];
 ...
 */
function a2j_author_preprocess_views_view(&$variables, $hook) {
  $view = $variables['view'];
 ...
 */
function a2j_author_preprocess_form(&$variables, $hook) {
 ...
 * need to perform some processing on attributes to make it work in a template.
 */
function a2j_author_process_form(&$variables, $hook) {
 ...
 */
function a2j_author_preprocess_form_content(&$variables, $hook) {
  // Bootstrap the with some of Drupal's default variables.
  template_preprocess($variables, $hook);
 ...
 */
function a2j_author_process_form_content(&$variables, $hook) {
  // Crunch down attribute arrays.
  template_process($variables, $hook);
}
 ...
 */
function a2j_author_preprocess_views_view_unformatted(&$variables, $hook) {
 ...
 */
function a2j_author_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function a2j_author_css_alter(&$css) {
 ...
 * will not render.
 */
function a2j_author_links($variables) {
 ...
 * characters.
 */
function _a2j_author_format_address(&$address) {
 ...
 */
function a2j_author_field__addressfield($variables) {
  $output = '';
  ...
  foreach($variables['items'] as &$address) {
    ...
    if ($address['#address']['administrative_area']) {
      _a2j_author_format_address($address);
    }
    else {
 ...
 */
function a2j_author_preprocess_views_view_field(&$variables, $hook) {
  ...
  if (isset($variables['theme_hook_suggestion']) && $variables['theme_hook_suggestion'] == 'views_view_field__field_address') {
    foreach ($variables['row']->field_field_address as $key => &$address) {
      if (!$address['raw']['administrative_area']) {
        ...
        _a2j_author_format_address($address['rendered']);
      }
    }
